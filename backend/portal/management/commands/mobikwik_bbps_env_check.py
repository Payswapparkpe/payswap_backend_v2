...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        vars_info = [
            ...
            ("MOBIKWIK_BBPS_BASE_URL", True, "UAT: alpha3.mobikwik.com | prod: rapi-b2b.mobikwik.com"),
            ("MOBIKWIK_BBPS_ENVIRONMENT", False, "UAT or PRODUCTION"),
            ("MOBIKWIK_BBPS_USE_ENCRYPTION", False, "True for View Bill / Validation"),
            ("MOBIKWIK_BBPS_TOKEN_USE_ENCRYPTION", False, "Optional: encrypted token body (default plain JSON per Mobikwik UAT Postman)"),
            ("MOBIKWIK_BBPS_TOKEN_PLAIN_JSON", False, "True = never encrypt token body (overrides TOKEN_USE_ENCRYPTION)"),
