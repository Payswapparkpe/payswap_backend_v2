...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        vars_info = [
            ...
            ("MOBIKWIK_BBPS_TOKEN_USE_ENCRYPTION", False, "Optional: force encrypted token body (B2B auto-encrypts for rapi-b2b host)"),
            ("MOBIKWIK_BBPS_TOKEN_PLAIN_JSON", False, "True = plain token JSON even on rapi-b2b (Mobikwik must confirm)"),
